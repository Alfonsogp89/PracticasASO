...
char *BUFFER = NULL;    //Buffer que se va a leer
char *LINE = NULL;      //Línea que se va a leer
bool fin = false;       //Variable que controla si hemos terminado de leer
int pos_buffer = 0;     //Posición inicial del buffer
...
int main(int argc, char *argv[]){
    ...
    // Los dos puntos indican que la opción requiere un argumento
...
int getSiguiente(){
    ...
    //Si no hemos llegado al final del buffer, leeremos de él
    }else{
